<?php
namespace Hawksama\PerformanceOptimization\Test\Unit\Plugin\Frontend\Magento\Framework\App\Response;
...
/**
 * @covers \Hawksama\PerformanceOptimization\Plugin\Frontend\Magento\Framework\App\Response\Http
 */
class HttpTest extends TestCase
{
     ...
     * Object to test
     *
     * @var \Hawksama\PerformanceOptimization\Plugin\Frontend\Magento\Framework\App\Response\Http
     */
    private $testObject;
    ...
    public function setUp()
    {
        ...
        \Hawksama\PerformanceOptimization\Plugin\Frontend\Magento\Framework\App\Response\Http::class,
            [
     ...
     * @return array
     */
    public function dataProviderForTestBeforeSendResponse()
    {
        return [
            'Testcase 1' => [
    ...
    /**
     * @dataProvider dataProviderForTestBeforeSendResponse
     */
    public function testBeforeSendResponse(array $prerequisites, array $expectedResult)
    {
     ...
     * @return array
     */
    public function dataProviderForTestMinifyHtml()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestMinifyHtml
     */
    public function testMinifyHtml(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestRemoveWhiteSpace()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestRemoveWhiteSpace
     */
    public function testRemoveWhiteSpace(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }

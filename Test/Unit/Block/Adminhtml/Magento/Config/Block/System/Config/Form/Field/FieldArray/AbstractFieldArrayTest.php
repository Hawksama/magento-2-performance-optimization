<?php
namespace Hawksama\PerformanceOptimization\Test\Unit\Block\Adminhtml\Magento\Config\Block\System\Config\Form\Field\FieldArray;
...
/**
 * @covers \Hawksama\PerformanceOptimization\Block\Adminhtml\Magento\Config\Block\System\Config\Form\Field\FieldArray\AbstractFieldArray
 */
class AbstractFieldArrayTest extends TestCase
{
     ...
     * Object to test
     *
     * @var \Hawksama\PerformanceOptimization\Block\Adminhtml\Magento\Config\Block\System\Config\Form\Field\FieldArray\AbstractFieldArray
     */
    private $testObject;
    ...
    public function setUp()
    {
        ...
        $this->elementFactory = $this->createMock(\Magento\Framework\Data\Form\Element\Factory::class);
        $this->testObject = $this->objectManager->getObject(
        \Hawksama\PerformanceOptimization\Block\Adminhtml\Magento\Config\Block\System\Config\Form\Field\FieldArray\AbstractFieldArray::class,
            [
     ...
     * @return array
     */
    public function dataProviderForTest_construct()
    {
        return [
            'Testcase 1' => [
    ...
    /**
     * @dataProvider dataProviderForTest_construct
     */
    public function test_construct(array $prerequisites, array $expectedResult)
    {
     ...
     * @return array
     */
    public function dataProviderForTestAddColumn()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestAddColumn
     */
    public function testAddColumn(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestGetArrayRows()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetArrayRows
     */
    public function testGetArrayRows(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestRenderCellTemplate()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestRenderCellTemplate
     */
    public function testRenderCellTemplate(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestIsAddAfter()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestIsAddAfter
     */
    public function testIsAddAfter(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestGetColumns()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetColumns
     */
    public function testGetColumns(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestGetAddButtonLabel()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetAddButtonLabel
     */
    public function testGetAddButtonLabel(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     */
    public function testRender(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestGetFormKey()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetFormKey
     */
    public function testGetFormKey(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestIsOutputEnabled()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestIsOutputEnabled
     */
    public function testIsOutputEnabled(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestGetAuthorization()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetAuthorization
     */
    public function testGetAuthorization(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
     ...
     * @return array
     */
    public function dataProviderForTestGetToolbar()
    {
        return [
            'Testcase 1' => [
                'prerequisites' => ['param' => 1],
    ...
    /**
     * @dataProvider dataProviderForTestGetToolbar
     */
    public function testGetToolbar(array $prerequisites, array $expectedResult)
    {
        $this->assertEquals($expectedResult['param'], $prerequisites['param']);
    }
